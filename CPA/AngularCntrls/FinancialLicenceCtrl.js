app.controller('FinancialCntrl', function ($scope, $filter, $http, $localStorage, DashboardService) {
    ...
    //Print pdf data
    $scope.FinancialPdfForm = function () {
        //alert()
        console.log($scope.ModelData)
        $scope.imgLoader_pdf = true;
        // print DMR164 Form
        DashboardService.FinancialLicencePDFService($scope.ModelData).then(function (res) {

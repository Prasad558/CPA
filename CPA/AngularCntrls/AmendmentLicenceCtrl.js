app.controller('AmdCntrl', function ($scope, $filter, $http, $localStorage, DashboardService) {
    ...
    //Print pdf data
    $scope.AmendmentPdfForm = function () {
        //alert()
        console.log($scope.ModelData)
        $scope.imgLoader_pdf = true;
        // print DMR164 Form
        DashboardService.AmendmentLicencePDFService($scope.ModelData).then(function (res) {
